    ...
    <div class="large-12 medium-12 small-12 cell">
      <div class="row">
        <div class="col-md">
          ...
          <div class="row">
            <div class="col-md">
              ...
              >
                <option v-for="person in people" :key="person.key">{{
                  person.name
                }}</option>
              </select>
            </div>
        ...
        <div class="col-md">
          <div class="row">
            <div class="col-md">
              <span>Naprężenie ścinające [Pa]:</span>
            </div>
          </div>
          <div class="row">
            <div class="col-md">
...
export default {
  ...
  methods: {
    submitInputs() {
      var temperatureValue = document.querySelector("input[name=Temperature]")
        .value;
      var shearStressValue = document.querySelector("input[name=ShearStress]")
        .value;
      ...
      axios
        ...
        .then((response) => {
          ...
          axios.get("api/Get").then((response) => {
            ...
            this.displayedValue =
              "Przewidywana lepkość dynamiczna: " + val + " [Pa·s]";
          });
        })
        .catch(function() {
          console.log("FAILURE!!");
